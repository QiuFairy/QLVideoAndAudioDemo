...
- (void)decoderAACBuffer:(NSData *)adtsAAC completionBlock:(void (^)(NSData *, NSError *))completionBlock {
    ...
    dispatch_async(_decoderQueue, ^{
        ...
        //去除atds头部
        NSData *aacData = [self aacRawDataFromADTSAAC:adtsAAC];
        ...
        do{
            ...
            // 解码
            OSStatus status = AudioConverterFillComplexBuffer(self.audioConverter,
