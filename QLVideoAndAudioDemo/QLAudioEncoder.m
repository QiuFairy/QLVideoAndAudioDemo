...
@property (nonatomic) QLAudioEncoder *encoder;

@end

@implementation QLAudioEncoder
- (void) dealloc {
...
{
    QLAudioEncoder *encoder = (__bridge QLAudioEncoder *)(inUserData);
